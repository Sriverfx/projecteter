...
const rooms = {
    ...
    "options" : {
      1 : {'weapon' : 'Attack snake with your shiny sword.',
          'nextRoom' : 'room2a'},
      2 : {'weapon' : 'Run to the door.',
      'nextRoom' : 'room2b'},
    },
    ...
    'room2a' : {
     "name" : "room 2a",
      ...
      "options" : {
        1 : {'weapon' : 'Attack the gold statue',
            'nextRoom' : 'room3'},
        2 : {'weapon' : 'Attack the silver statue',
        'nextRoom' : 'room7'},
      },
      terminatingRoom : false
    },
    ...
    'room3' : {
      ...
      "options" : {
        1 : {'weapon' : 'Trust your other senses and find the next door being blind. ',
            'nextRoom' : 'room4a'},
        2 : {'weapon' : 'You remember that you have also have some magic matches.',
        'nextRoom' : 'room4b'},
      },  
    ...
    'room4b' : {
      ...
      "options" : {
        1 : {'weapon' : 'Attack him him with your sword. ',
            'nextRoom' : 'room12'},
        2 : {'weapon' : 'Try to block his first attack and then attack him',
        'nextRoom' : 'room5b'},
      },  
    ...
    'room7' : {
      ...
      "options" : {
        1 : {'weapon' : 'You believe in the power of the silver dust and you attack them.',
            'nextRoom' : 'room111'},
        2 : {'weapon' : 'Try to avoid their fireball and atack them with your power skill.',
        'nextRoom' : 'room8'},
      },
    ...
    'room8' : {
      ...
      "options" : {
        1 : {'weapon' : 'Dragons doesnt exist this is in my imagination. Attack! ',
            'nextRoom' : 'room12'},
        2 : {'weapon' : 'You are experienced after all this battles. Avoid his fire and stab him in the neck.',
        'nextRoom' : 'room222'},
      },
    ...
    'room12' : {
      ...
      "options" : {
        1 : {'weapon' : 'Try again',
            'nextRoom' : 'room1'},
        2 : {'weapon' : 'Come on give it a try',
        'nextRoom' : 'room1'},
      },
      terminatingRoom : false
    },
